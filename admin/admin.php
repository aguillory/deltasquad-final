		...
		<div>
			...
			<div class="card card1">
						...
						<form action="adminprocess.php" method="POST" id="update" name='update'>
							...
							<div class="input-field col s12">
								<select form="update" name="upduser">
									<?php
										$q = "SELECT * FROM ".TBL_USERS." WHERE username != 'ULM Calendar' ORDER BY username";
						...
						<form action="adminprocess.php" method="POST" id="deletecourse">
							...
							<div class="input-field col s12">
								<select class="drop" form="lead" name="user">
									...
									<?php
										$q = "SELECT * FROM ".TBL_USERS." WHERE userlevel >=5 AND username != 'ULM Calendar' ORDER BY username";
										$result = $database->query($q);
										$num_rows = mysql_numrows($result);
										for($i=0; $i<$num_rows; $i++){
											$username  = mysql_result($result,$i,"username");
				...
				<div>
					...
					<div class="in"><a href="wizard.php">
					<button class="btn waves-effect waves-light" type="button">Run Semester Creation Wizard
								<i class="material-icons right">send</i>
							</button>
							</a></div>
					<hr>
