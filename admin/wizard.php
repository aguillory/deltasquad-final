...
<?php
	...
	*/
	...
	<h5>Add Section/CRN</h5>
										...
										<div class="input-field col s12">
											<input id="coursename" type="number" required max="99999" class="validate" name="crn" maxlength="30">
						...
						<form class="col s12" action="adminprocess.php" method="POST" id="instruct">
							...
							<div class="input-field col s12">
								<select multiple name="crn[]" required size=5>
	...
	<h5>Assign Lead Instructor Role:</h5>
								...
								<div class="input-field col s12">
									...
									<label>Select an instructor's username</label>
								</div>
								...
								<input type="hidden" required name="sublead" value="1">
